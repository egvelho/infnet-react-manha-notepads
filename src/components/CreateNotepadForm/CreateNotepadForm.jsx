...
export function CreateNotepadForm({ onCreateNotepadSuccess }) {
  ...
  function setTouched(setTouchedFn) {
    setTouchedFn(true);
  }
      ...
      <form className={style.form} onSubmit={onFormSubmit}>
        <fieldset>
          <TextField
            ...
            value={title}
            onChange={value => { setTitle(value); setTouched(setTitleTouched); }}
        ...
        <fieldset>
          <TextField
            ...
            value={subtitle}
            onChange={value => { setSubtitle(value); setTouched(setSubtitleTouched); }}
        ...
        <fieldset>
          <TextArea
            ...
            value={content}
            onChange={value => { setContent(value); setTouched(setContentTouched); }}
